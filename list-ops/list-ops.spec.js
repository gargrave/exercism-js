...
describe('List', function () {
  ...
  //     spyOn(Array.prototype, 'reduceRight').and.callThrough();
  ...
  //     expect(Array.prototype.reduceRight).not.toHaveBeenCalled();
  //   });
  //   it('Array.prototype.concat()', function () {
  //     expect(Array.prototype.concat).not.toHaveBeenCalled();
  //   });
